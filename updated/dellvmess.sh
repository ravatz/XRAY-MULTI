...
sed -i "/^### $user $exp/,/^},{/d" /etc/xray/config.json
rm -f /etc/xray/vmess-$user-tls.json /etc/xray/vmess-$user-nontls.json /etc/xray/vmess-$user-wf.json /etc/xray/vmess-$user-grpc.json
rm -f /home/vps/public_html/$user-VMESSNTLS.yaml
rm -f /home/vps/public_html/$user-VMESSTLS.yaml
rm -f /home/vps/public_html/$user-VMESSWF.yaml
