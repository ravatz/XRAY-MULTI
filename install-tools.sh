...
# ==================================================
# Link Hosting Kalian
ravavpn="raw.githubusercontent.com/ravatz/XRAY-MULTI/main/conf"
...
curl https://${ravavpn}/nginx.conf > /etc/nginx/nginx.conf
curl https://${ravavpn}/vps.conf > /etc/nginx/conf.d/vps.conf
...
wget -O /home/vps/public_html/index.html "https://${ravavpn}/index.html"
