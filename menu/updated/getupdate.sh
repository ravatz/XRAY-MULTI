...
echo "Checking VPS"
IZIN=$(curl https://raw.githubusercontent.com/ravatz/cfnfree/main/ipvps.txt | grep $MYIP | awk '{print $3}')
if [ $MYIP = $MYIP ]; then
...
clear
lizupdate="raw.githubusercontent.com/ravatz/cfnfree/main/update"
# change direct
cd /usr/bin
# remove file
rm menu
